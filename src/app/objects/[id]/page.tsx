...
export default function ObjectPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main>
      ...
      <div className="container-fluid  object-page">
        {load ?
          <>
            <section className={styles.section}>
              ...
              <div className={styles.box}>
                ...
                {/* <span className={styles.created}>Создана 12 января, 12:09</span> */}
              </div>
              ...
              <div className={styles.specs}>
                ...
                <div className={styles.specs__item}>
                  ...
                  <div className={styles.specs__right}>
                    ...
                    <span>{object?.condition.buildingYear} {object?.condition.buildingQuarter}</span>
                  </div>
                </div>
                <div className={styles.specs__item}>
                  <div className={styles.specs__left}>
