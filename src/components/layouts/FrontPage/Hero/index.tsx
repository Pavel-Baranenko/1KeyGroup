        ...
        <div className="wrap-linear-section">
          <div className={styles.wrap}>
            <div className={styles.info}>
              ...
              <Link href="./auth/sing-up" className="blue-btn" >
                <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M7.65814 3.09484L3.56924 8.92532H6.6374C7.02644 8.92532 7.34182 9.2407 7.34182 9.62974V12.9051L11.4307 7.0746H8.36257C7.97352 7.0746 7.65814 6.75922 7.65814 6.37018V3.09484ZM7.48924 1.39858C7.88451 0.834954 8.77039 1.11464 8.77039 1.80304V5.96236H12.2148C12.785 5.96236 13.119 6.60443 12.7916 7.07124L7.51073 14.6013C7.11546 15.165 6.22957 14.8853 6.22957 14.1969V10.0376H2.78512C2.21494 10.0376 1.88101 9.3955 2.20838 8.92868L7.48924 1.39858Z" fill="white" />
                </svg>
            ...
            <div className={styles.video}>
              ...
              <button className={styles.play}>
                <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g opacity="0.76" clipPath="url(#clip0_32_7689)">
